...
#include "JButtonB.generated.h"

class UButton;
class UTextBlock;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FJButtonBClick, const int32, Id);
...
class JUTILS_API UJButtonB: public UUserWidget {
	GENERATED_BODY()
