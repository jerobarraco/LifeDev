...
// DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FSubExpressionEnd, 0x125E4C67, 0x96EB48C4, 0x8894E09C, 0xB3CD56BF)

// DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FPlus, 0x6F88756B, 0xF9234263, 0x9B13614F, 0x2706074B)
// DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FPlusEquals, 0x05A878C9, 0x0E6C44A4, 0x9A73920D, 0x3175AB48)
// DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FMinus, 0xE6240779, 0xEE2849CF, 0x95A0E648, 0x22D58713)
// DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FMinusEquals, 0x8D1E08E3, 0x5F534245, 0xA987AD7E, 0xDB78A4B7)
// DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FStar, 0xF287B3BF, 0x35DF4141, 0xA8B4F57B, 0x7E06DF47)
// DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FStarEquals, 0xBA359BB0, 0xCEB54682, 0x9160EB4F, 0xD1687C7F)
...
DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FSaturate, "JMathSaturate") // not working
DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FAbsolute, "JMathAbsolute")// not working
DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FRand, "JMathRand") // works
DEFINE_EXPRESSION_OPERATOR_NODE(JUTILS_API, FNot, "JMathNot") // works
