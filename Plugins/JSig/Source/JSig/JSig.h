...
// To use, just enable this plugin and add a CSignificance component to your actors.
// Read the docs on the component.
//
// you can set the defaults for this class if you create a file in Config/DefaultJSig
...
public:
	...
	// This will make some of the delegates and functions of the components to run on a background thread.
