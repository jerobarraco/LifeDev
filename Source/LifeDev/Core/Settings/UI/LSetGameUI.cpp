...
void ULSetGameUI::NativeOnInitialized() {
	...
	if (LIKELY(FeatsGroup)) FeatsGroup->SetUp({
		...
		{EFeat::G_CARD0, NSLOCTEXT("SetGame", "Feat", "Card 0")},
		{EFeat::G_CARD1, NSLOCTEXT("SetGame", "Feat", "Card 1")},
		{EFeat::G_CARD2, NSLOCTEXT("SetGame", "Feat", "Card 2")},
		{EFeat::G_CARD3, NSLOCTEXT("SetGame", "Feat", "Card 3")},
		{EFeat::G_CARD4, NSLOCTEXT("SetGame", "Feat", "Card 4")},
